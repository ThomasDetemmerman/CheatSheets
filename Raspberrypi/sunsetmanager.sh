...
# - Not equal or less then 2.5 minutes, in such cases it's possible that the scrirpt runs two times within the same 5 minutes timeframe
...
then 
    ...
    shutdown -r +5 "toggeling infrared camera due to sunset. Rebooting within 5 mins"
fi
